...
function parseByteArray(byteArray) {
    ...
    try{
        ...
        {
            console.log('#patientId', "element has no data");
        }
        ...
        {
            console.log('#otherPatientIds', patientId);
        }
        else
        {
            console.log('#otherPatientIds', "element not present");
        }
        ...
        {
            console.log('#rows', "element not present or has no data");
        }
        ...
        if(referencedImageSequence !== undefined)
        {
            ...
            if(referencedImageSequence.items.length > 0)
            {
                ...
                console.log('#referencedSOPClassUID', referencedSOPClassUID);
            }
        }
        ...
        if(dataSet.elements.x00200032 !== undefined) {
            ...
            console.log('#imagePositionPatientX', imagePositionPatientX);
            console.log('#imagePositionPatientY', imagePositionPatientY);
            console.log('#imagePositionPatientZ', imagePositionPatientZ);
        }
        ...
        if(dataSet.elements.x00200032 !== undefined) {
            ...
            text += ")";
            console.log('#imagePositionPatientNumValues', text);
        }
        ...
        console.log('#sopInstanceUidDataOffsetAndLength', text);
        ...
        if(sopInstanceUidElement.vr !== undefined) {
            console.log('#sopInstanceUidVR', sopInstanceUidElement.vr);
        }
    }
    catch(err)
    {
